...
static void loadTextGroup() {
	...
	gStoryScreenData.mSpeakerID = addMugenText(speaker, makePosition(120 / 2, 334 / 2, 3), 1);

	gStoryScreenData.mTextID = addMugenText(text, makePosition(80 / 2, 392 / 2, 3), 1);
...
static void loadStoryScreen() {
	...
	if (!strcmp("INTRO", gStoryScreenData.mDefinitionPath) || !strcmp("OUTRO", gStoryScreenData.mDefinitionPath)) {
